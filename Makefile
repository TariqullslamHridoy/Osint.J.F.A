...
run:
	...
	@echo -e "\e[34m######## Building and Running Osint.J.F.A with Docker-compose ########\e[0m"
	...
	docker-compose run --rm Osint.J.F.A $$username
...
build-run-testing:
	...
	@docker-compose run --name Osint.J.F.A-testing -d --rm --entrypoint "sleep infinity" Osint.J.F.A || exit 1
	@echo -e "\e[32m[#] Osint.J.F.A-test container is now Running!\e[0m"

cleanup-testing:
	@echo -e "\e[34m######## Cleanup Build-run-testing Container ########\e[0m"
	@docker-compose down
	@echo -e "\e[32m[#] Osint.J.F.A-test container has been removed\e[0m"
