...
from src.Osint.J.F.A import Osint.J.F.A
import argparse
...
def printlogo():
    ...
    pc.printout("\nVersion 1.1 - Developed by Tariqul IsIam Hridoy\n\n", pc.YELLOW)
...
api = Osint.J.F.A(args.id, args.file, args.json, args.command, args.output, args.cookies)
